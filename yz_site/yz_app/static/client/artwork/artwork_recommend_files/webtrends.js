	...
	****************************************************************************/
	...
	Webtrends.dcs.prototype = {
		init: function (config) {
			...
			this.FPCConfig.expiry = this['FPCConfig']['expiry'] = sdcfg(config['FPCConfig'], 'expires', sd('cookieexpires', 315360000000));
			this.FPCConfig.expiry = (this.FPCConfig.expiry < 315360000000) ? this.FPCConfig.expiry : 315360000000;
