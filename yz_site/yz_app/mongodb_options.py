...
def insert_client(db, client_id, username, password, gender, age, date, email, phone_num,status):
    db.clients.insert({'client_id': client_id, 'username': username, 'password': password, 'gender': gender, 'age': age, 'date': date, 'email': email, 'phone_num': phone_num,'status':status})
